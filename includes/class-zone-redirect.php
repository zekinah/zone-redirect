...
class Zone_Redirect {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Zone_Redirect_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-zone-redirect-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-zone-redirect-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-zone-redirect-public.php';

		$this->loader = new Zone_Redirect_Loader();
	 ...
	 *
	 * Uses the Zone_Redirect_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Zone_Redirect_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Zone_Redirect_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Zone_Redirect_Loader    Orchestrates the hooks of the plugin.
	 */
